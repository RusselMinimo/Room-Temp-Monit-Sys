...
export const metadata: Metadata = {
  title: "API Keys · IoT Room Monitoring",
  description: "Manage API keys and access tokens for system integration.",
};
      ...
      <DashboardLayout>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground max-w-2xl">
                Generate and manage API keys for programmatic access to the system.
              </p>
            </div>
        ...
        <section className="space-y-6">
          <div className="rounded-xl border border-border/70 bg-card/80 p-6 shadow-sm backdrop-blur-sm">
            <p className="text-sm text-muted-foreground">
              API key management coming soon. This page will allow you to create, view, and revoke API keys for system integration.
            </p>
          </div>
